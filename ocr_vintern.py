...
Original file is located at
    https://colab.research.google.com/drive/1xsbNN7PG18KfDoPEPhuz4STGRfvc3Cu3
"""
...
# Use a different image URL that points directly to a JPG file
image_url = "https://cdn2.fptshop.com.vn/unsafe/800x0/mau_chu_thu_phap_1_39c130d883.jpg" # Changed URL

# Define the output filename
output_filename = "downloaded_image.jpg"

# Use -O to specify the output filename for wget
!wget {image_url} -O {output_filename}

test_image = output_filename

# Add these lines to check the current directory and files
import os
