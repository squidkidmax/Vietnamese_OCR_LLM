...
# ----------------- Paths & constants -----------------
BASE_DIR = Path("/Users/maxnguyen/PycharmProjects/Intro_to_com/Test OCR Vietnam")
...
# Use float32 on CPU to avoid bfloat16 kernel traps on macOS
...
# Professor demo: keep a hard-coded fallback key (unsafe for real projects).
HARDCODED_OPENAI_KEY = "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"
